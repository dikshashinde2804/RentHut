...
function SeeYourBooking() {
    ...
    useEffect(() => {
        const fetchBookings = async () => {
            ...
            try {
                const response = await axios.get(`https://renthut-backend.vercel.app/getBooking/${userId}`, {
    ...
    const handleCancel = async (bookingId) => { // Accept bookingId as a parameter
        try {
            const response = await axios.delete(`https://renthut-backend.vercel.app/cancelBooking/${bookingId}`, {
